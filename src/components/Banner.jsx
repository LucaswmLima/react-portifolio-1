      ...
      <Container>
        <Row className="align-itens-center">
          <Col xs={12} md={6} xl={7}>
            ...
            <p>
            Desenvolvedor formado em engenharia da computação e apaixonado por tudo relacionado a tecnologia e ciência. Atualmente a procura de uma oportunidade na area.
            </p>
            <Row>
           <Col xs={12} md={6} xl={5}>
